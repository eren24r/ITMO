...
public class Static {
    ...
    static
    {
        ...
        listOfCommand.put(new AddUserCmd().getName(), new AddUserCmd());
        listOfCommand.put(new LogInCmd().getName(), new LogInCmd());
        listOfCommand.put(new User().getName(), new User());
        listOfCommand.put(new LogOut().getName(), new LogOut());
    }
