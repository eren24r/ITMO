...
public class Organization {
    ...
    public Organization(int id, String name, Coordinates coordinates, LocalDateTime creationDate, Float annualTurnover, OrganizationType type, Address postalAddress, int userId){
        this.id = id;
        this.name = name;
    ...
    public Organization(String name, Coordinates coordinates, Float annualTurnover, OrganizationType type, Address postalAddress, String user) throws IOException {
    ...
    public String toStringCSV() {
        return (String) ("\"" + this.id + "\"," + "\"" + this.name + "\"," + "\"" + this.coordinates.getX() + "\"," + "\"" + this.coordinates.getY() + "\"," + "\"" + this.getCreationDate() + "\"," + "\"" + this.annualTurnover + "\"," + "\"" + this.type.name() + "\"," + "\"" + this.postalAddress.getStreet() + "\"," + "\"" + this.postalAddress.getZipCode() + "\"," + "\"" + this.userId + "\"");
    }
