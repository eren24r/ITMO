...
public class CheckAreaResultsBean implements Serializable {
    ...
    @Inject
    private PointCounter areaMBeanImpl;
    @Inject
    private ClickInterval clickIntervalIml;

    @Inject
    private Agent agentImlImpl;

    private static LinkedList<CheckAreaBean> results;
    ...
    public void newResult(final double x, final double y, final double r) {
        ...
        agentImlImpl.add(x, y, r);
        agentImlImpl.click(executionTime);
    }
