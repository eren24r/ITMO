...
HD_PWD='C:/Users/asus/Documents/vivado/lab3/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log func.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source func.tcl -notrace
