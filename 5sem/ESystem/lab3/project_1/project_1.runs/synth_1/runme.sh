...
HD_PWD='C:/Users/asus/Documents/vivado/lab3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log func.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source func.tcl
